...
public class Logger {
    ...
    public Logger(Context context) {
        LoggerSetup(context.getPackageName(), "application.txt", Level.INFO);
    }
    ...
    public Logger() {
        LoggerSetup("", "application.txt", Level.INFO);
    }
    ...
    private File createWriter(String logFilename) {
        try {
            ...
            if (state.equals(Environment.MEDIA_MOUNTED)) {
                File dir = new File(Environment.getExternalStorageDirectory(), "com.iitr.vishal.expensetracker");
                if (!dir.mkdirs()) {
